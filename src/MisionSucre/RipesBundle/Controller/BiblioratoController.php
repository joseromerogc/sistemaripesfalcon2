...
use MisionSucre\RipesBundle\Entity\Bibliorato;
use Doctrine\ORM\EntityRepository;
use Symfony\Component\HttpFoundation\Request;
use Symfony\Component\Validator\Constraints;

class BiblioratoController extends Controller
{
	...
	{       
            ...
            'Ambiente con ID: '.$idambiente.' no registrado'
                ...
                $bibliorato = new Bibliorato();
                
                $form = $this->createForm(new BiblioratoType(),$bibliorato)->
